...
export class AuthController {
  ...
  @Put('password')
  async update(@Body() passwordInfo: UpdateUserPasswordDto, @Request() req: Request) {
    await this.authService.updatePassword(+req.user.id, passwordInfo.oldPassword, passwordInfo.password);
  }
